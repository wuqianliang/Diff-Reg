...
class Matching(nn.Module):
    ...
    def __init__(self, config, mutual=True):
        super().__init__()
    ...
    def forward(self, src_feats, tgt_feats,  src_mask, tgt_mask, mutual = True):
        '''
        ...
        # else:
        #     coarse_match, _, _ = self.get_match(conf_matrix, self.confidence_threshold)
        #     b_ind, src_indices, tgt_indices = coarse_match[:,0], coarse_match[:,1], coarse_match[:,2]

        return conf_matrix, src_indices, tgt_indices, weights
