...
class ImageBackbone(nn.Module):
    ...
    def forward(self, x, dino_feat = None):
        ...
        dino_feat = dino_feat.permute(0,3,1,2).contiguous()
        interp_dino = F.interpolate(dino_feat, size=feats_s4.shape[2:], mode="bilinear", align_corners=True)  

        # decoder
        latent_s4 = self.decoder4_1(feats_s4 + interp_dino)  # (1/8)
