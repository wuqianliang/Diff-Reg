...
_C.exp.output_dir = osp.join("7scenes_output", _C.exp.name)
...
# data
_C.data = edict()
_C.data.dataset_dir = "../../../2D3DMatch/2D3DMATR/2D3DMATR-main/data/7Scenes"
...
# diffusion
_C.model.coarse_matching.SAMPLE_STEP = 10

_C.model.coarse_matching.feature_dim = 256
_C.model.coarse_matching.entangled = False
_C.model.coarse_matching.confidence_threshold = 0.2
_C.model.coarse_matching.dsmax_temperature = 0.1
_C.model.coarse_matching.match_type = 'sinkhorn' # [sinkhorn, dual_softmax]
_C.model.coarse_matching.skh_init_bin_score = 1.0
_C.model.coarse_matching.skh_iters = 3
_C.model.coarse_matching.skh_prefilter = False


_C.procrustes = edict()
_C.procrustes.max_condition_num = 200 
_C.procrustes.sample_rate = 1.0


# model - GeoTransformer
_C.model.transformer = edict()
_C.model.transformer.img_input_dim = 512
_C.model.transformer.pcd_input_dim = 512#1024
