...
_C.exp.output_dir = osp.join("rgbv2_output", _C.exp.name)
...
# data
_C.data = edict()
_C.data.dataset_dir = "../../../2D3DMatch/2D3DMATR/2D3DMATR-main/data/RGBDScenesV2"
...
# diffusion
_C.model.coarse_matching.SAMPLE_STEP = 50
...
_C.model.transformer.pcd_input_dim = 512
