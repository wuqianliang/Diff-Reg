...
model = DepthAnything.from_pretrained('LiheYoung/depth_anything_vitl14', cache_dir='depth_anything_vitl14').to(DEVICE).eval()
...
if __name__ == '__main__':
    ...
    img = cv2.imread('/data_wql/2D3DMatch/2D3DMATR/2D3DMATR-main/data/RGBDScenesV2/data/rgbd-scenes-v2-scene_06/color_028.png')
    data = on_submit(img)